...
class CreateResetControllerCommand extends AbstractCommand
{
    private const COMMAND         = 'make:controller:reset';
    private const DESCRIPTION     = 'Add a password reset controller to your application.';
    ...
    private const NAME_CONTROLLER = 'ResetController';
