...
class CreateRegisterControllerCommand extends AbstractCommand
{
    private const COMMAND         = 'make:controller:register';
    private const DESCRIPTION     = 'Add a register controller to your application.';
    ...
    private const NAME_CONTROLLER = 'RegisterController';
